...
csvgrep -c type -r "large|medium" source/airports.csv | csvcut -c municipality,type,iata_code,latitude_deg,longitude_deg,iso_country > airports_large_medium.csv
...
csvgrep -c type -r "large" source/airports.csv | csvcut -c municipality,iata_code,latitude_deg,longitude_deg,iso_country > airports_large.csv
