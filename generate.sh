...
csvgrep -c scheduled_service -r "yes" source/airports.csv | csvgrep -c type -r "large|medium" | csvcut -c municipality,iata_code,latitude_deg,longitude_deg,iso_country > airports_large_medium.csv
...
csvgrep -c scheduled_service -r "yes" source/airports.csv | csvgrep -c type -r "large" | csvcut -c municipality,iata_code,latitude_deg,longitude_deg,iso_country > airports_large.csv
